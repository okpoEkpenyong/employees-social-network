...
router.post('/api/auth/signin', auth, database.loginEmployee);     // POST or signin: Admin/employee
router.post('/api/auth/create-user', auth, database.signupEmployee)   // POST or create a new employee/signup
